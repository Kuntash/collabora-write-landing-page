...
export const HeaderSection = () => {
  return (
    <header
      id="header"
      className="flex flex-col items-center relative antialiased"
    >
      <motion.h1
      ...
      <motion.div
        className="absolute bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-pink-500/10 blur-2xl w-[120%] h-[150%] -top-[20%] z-1 rounded-full"
        initial={{ opacity: 0 }}
